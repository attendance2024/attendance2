...
urlpatterns = [
    path('', views.teacher_login, name='teacher'),
    ...
    path('get_princi/', views.get_princi, name='get_princi'),
    ...
    path('princi_accept/',views.princi_accept, name='princi_accept'),
    path('add_event/', views.add_event, name='add_event'),
    path('generate_report/', views.generate_report, name='generate_report'),
    path('create_student/', views.addstudent, name='create_student'),
    path('create_teacher/', views.addteacher, name='create_teacher'),
    path('assign_teacher_position/', views.assign_teacher_position, name='assign_teacher_position'),
